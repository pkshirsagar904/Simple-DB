...
//    		System.out.print("left tuple: " + lt.toString());
//    		System.out.print("Present left tuple: " + t1.toString());
				 while(child2.hasNext()) 
				 {
                         Tuple tup2 = this.child2.next();
 //        		System.out.print("right tuple: " + tup2.toString());
                          if(p.filter(lt, tup2) ) 
						{
//System.out.println(concatenate(tup1, tup2));
                       return concatenate(lt, tup2);
						} 
                 }
					 t1=null;
					 child2.rewind();
